    ...
    <div className="container-legal py-10 md:py-14">
      <div className="max-w-3xl">
        ...
        <div className="space-y-6 text-[14.5px] leading-8 text-[#1a1a1a]">
          <p>
            قانون‌یاب (ghanunyab.ir) پایگاهی است که با هدف تسهیل دسترسی شهروندان،
          ...
          <p>
            ...
            پرزحمت در منابع متعدد است. قانون‌یاب با ارائه خط زمانی تفصیلی برای
          ...
          <p>
            محتوای قانون‌یاب بر اساس متن رسمی قوانین منتشرشده در روزنامه رسمی
            جمهوری اسلامی ایران و پایگاه حقوقی مجلس شورای اسلامی تهیه شده است.
            تیم ویراستاری قانون‌یاب، اصلاحات اعمال‌شده بر هر قانون را به‌صورت
          ...
          <p>
            با وجود تلاش برای ارائه دقیق و به‌روز، قانون‌یاب جایگزین منابع رسمی
          ...
          <p>
            ...
            <a href="#" className="link-legal cite">info@ghanunyab.ir</a> با تیم
            قانون‌یاب در ارتباط باشید.
          </p>
        </div>
