    ...
    <div className="container-legal py-10 md:py-14">
      <div className="max-w-3xl">
        ...
        <h1 className="font-legal text-[28px] md:text-[32px] font-light text-[#1a1a1a] leading-tight mb-6">
          پایگاه خصوصی قوانین جمهوری اسلامی ایران
        </h1>

        <div className="space-y-6 text-[14.5px] leading-8 text-[#1a1a1a]">
          <p>
            مدونات (modavanat.ir) یک پایگاه خصوصی و غیررسمی است که با هدف تسهیل دسترسی
            شهروندان، حقوقدانان، پژوهشگران و دانشجویان به متن قوانین و مقررات جمهوری اسلامی
