...
function formatJalaliDate(jalaliStr) {
...
function shortJalaliDate(jalaliStr) {
...
function statusPillClass(status) {
    switch(status){
        case "in-force":
            return "pill pill-in-force";
        case "amended":
            return "pill pill-amended";
        case "revoked":
            return "pill pill-revoked";
        case "pending":
...
function provisionRefLabel(ref) {
